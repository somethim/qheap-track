...
const props = defineProps<PaginatedData<Client>>();
...
const showClient = (row: Client) => {
    router.visit(clients.show(row.id).url);
};

const addClient = () => {
    router.visit(clients.create().url);
};
